						...
						<div className='mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 sm:py-20 lg:max-w-7xl lg:grid-cols-2 lg:px-5'>
							<div>
								...
								<p className='mt-4 text-gray-500'>
									...
									perfectly fit a stack of Focus cards. The powder
									coated steel divider separates active cards from new
								...
								<dl className='mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8'>
									...
									<div className='border-t border-gray-200 pt-4'>
										...
										<dd className='mt-2 text-sm text-gray-500'>
											Solid walnut base with rare earth magnets and
											powder coated steel card cover
										</dd>
									</div>
									...
									<div className='border-t border-gray-200 pt-4'>
										...
										<dd className='mt-2 text-sm text-gray-500'>
											Made from natural materials. Grain and color
											vary with each item.
										</dd>
									</div>
								</dl>
